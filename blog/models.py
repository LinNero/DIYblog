...
class Blog(models.Model):
    ...
    post_date =models.DateTimeField(auto_now_add=True) #дата заносится в поле таблицы при создании этого поля,
    author = BlogUser()       # сама бд его создает, нам не надо отдельноеё заносить
